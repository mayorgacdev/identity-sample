...
namespace IdentitySample.Infrasctructure.Migrations
{
    ...
    [Migration("20251003232311_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentitySample.Entities.Auth.ApplicationCustomUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("IdentitySample.Entities.Auth.IdentityCustomRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IdentitySample.Entities.Auth.ApplicationCustomUserRole", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", null)
                        .WithOne()
                        .HasForeignKey("IdentitySample.Entities.Auth.ApplicationCustomUserRole", "UserId", "RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
